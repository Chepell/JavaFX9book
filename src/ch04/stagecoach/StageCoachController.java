...
public class StageCoachController {
	...
	public void setupBinding(StageStyle stageStyle) {
		...
		textStageH.textProperty().bind(new SimpleStringProperty("height: ").concat(stage.heightProperty().asString()));
		textStageF.textProperty().bind(new SimpleStringProperty("focused: ").concat(stage.focusedProperty().asString()));
...
//		stage.titleProperty().bind(title);
		...
		// заменяет две предыдущие строки и необходимость использовать поле StringProperty title
